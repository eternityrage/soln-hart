...
def main():
    ...
    title = "Solenessa Hartley Daily"
    description = "#shorts #solenessahartley"
    tags = ['fashion', 'beauty', 'lifestyle', 'travel', 'style', 'minimalist', 'quietluxury', 'photography', 'wellness', 'solenessahartley', 'ootd', 'skincare', 'selfcare', 'inspiration', 'liveelegantly']
