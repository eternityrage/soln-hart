...
def upload_to_vk(video_path, description="", title=""):
    ...
    try:
        ...
        # Prepare message
        message = description if description else "💬 Solenessa Hartley Daily!\n\n#solenessahartley"
        ...
        video = upload.video(
            ...
            name=title or 'Solenessa Hartley Video',
...
def main():
    ...
    title = sys.argv[3] if len(sys.argv) > 3 else "Solenessa Hartley"
